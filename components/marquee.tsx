...
export function Marquee({
  ...
  return (
    <div className={cn("relative flex w-full overflow-hidden py-4", className)}>
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 md:w-24 bg-gradient-to-r from-background to-background/0" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 md:w-24 bg-gradient-to-l from-background to-background/0" />
